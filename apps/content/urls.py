...
urlpatterns = [
    ...
    path(_('arabic-language/'), views.ContentListView.as_view(
    ...
    path(_('islamic-finance/'), views.ContentListView.as_view(
    ...
    path(_('islamic-sciences/'), views.ContentListView.as_view(
